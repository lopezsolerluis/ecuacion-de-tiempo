...
if((i < len)){
var k = (ks[i]);
var G__13312 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__13313 = (i + (1));
m = G__13312;
i = G__13313;
continue;
...
var temp__5722__auto__ = p.argv;
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__13314 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__13314);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13316 = c;
var G__13316__$1 = (((G__13316 == null))?null:G__13316.prototype);
if((G__13316__$1 == null)){
return null;
} else {
return G__13316__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13318 = c;
var G__13318__$1 = (((G__13318 == null))?null:G__13318.prototype);
if((G__13318__$1 == null)){
return null;
} else {
return G__13318__$1.render;
}
})() == null)))));
});
...
var G__13320 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__13320) : reagent.impl.component.as_element.call(null,G__13320));
};
...
var G__13326 = c;
var G__13326__$1 = (((G__13326 == null))?null:G__13326.constructor);
if((G__13326__$1 == null)){
return null;
} else {
return G__13326__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__13327 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__13328 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__13328);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__13327);
}});
...
var G__13329 = key;
var G__13329__$1 = (((G__13329 instanceof cljs.core.Keyword))?G__13329.fqn:null);
switch (G__13329__$1) {
...
var c = this;
var G__13332_13334 = goog.object.get(c,"cljsRatom");
if((G__13332_13334 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13332_13334);
}
...
var renders_13335 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_13336 = cljs.core.first(cljs.core.vals(renders_13335));
...
if((cljs.core.count(renders_13335) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_13335))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_13336)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_13336], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__13337 = o;
goog.object.set(G__13337,cljs.core.name(k),v);
